...
var result = myarrs.reduce(function(total,curvalue,curidx,arr){
	// console.log('this is total = ',total); //0 underfined  //if we use 1 peramenter 10 underfined
	// console.log('this is curvalue = ',curvalue); //10 to 100 by number // if we use 1 permenter 20 to 100 by number
	// console.log('this is curidx = ',curidx);  //0 to 9 index number // if we use 1 permenter 1 to 0 index number
	// console.log(arr);
